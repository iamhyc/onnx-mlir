// RUN: onnx-mlir-opt --convert-onnx-to-linalg='linalg-ops=onnx.MatMul' %s -split-input-file | FileCheck %s

// -----

// Test MatMul 2D x 2D
func.func @test_matmul_2d(%arg0: tensor<2x3xf32>, %arg1: tensor<3x4xf32>)
    -> tensor<2x4xf32> {
  %0 = "onnx.MatMul"(%arg0, %arg1) : (tensor<2x3xf32>, tensor<3x4xf32>)
      -> tensor<2x4xf32>
  ...
  // CHECK: [[RESULT:%.+]] = linalg.matmul ins(%arg0, %arg1 : tensor<2x3xf32>,
  // tensor<3x4xf32>) outs([[FILLED]] : tensor<2x4xf32>) -> tensor<2x4xf32>
...
func.func @test_matmul_different_sizes(%arg0: tensor<5x10xf32>,
    %arg1: tensor<10x3xf32>) -> tensor<5x3xf32> {
  %0 = "onnx.MatMul"(%arg0, %arg1) : (tensor<5x10xf32>, tensor<10x3xf32>)
      -> tensor<5x3xf32>
  ...
  // tensor<5x10xf32>, tensor<10x3xf32>) outs([[FILLED]] : tensor<5x3xf32>)
  // -> tensor<5x3xf32>
...
func.func @test_matmul_square(%arg0: tensor<4x4xf32>, %arg1: tensor<4x4xf32>)
    -> tensor<4x4xf32> {
  %0 = "onnx.MatMul"(%arg0, %arg1) : (tensor<4x4xf32>, tensor<4x4xf32>)
      -> tensor<4x4xf32>
  ...
  // CHECK: [[RESULT:%.+]] = linalg.matmul ins(%arg0, %arg1 : tensor<4x4xf32>,
  // tensor<4x4xf32>) outs([[FILLED]] : tensor<4x4xf32>) -> tensor<4x4xf32>
...
func.func @test_matmul_3d_batch_not_lowered(%arg0: tensor<2x3x4xf32>,
    %arg1: tensor<2x4x5xf32>) -> tensor<2x3x5xf32> {
  %0 = "onnx.MatMul"(%arg0, %arg1) : (tensor<2x3x4xf32>, tensor<2x4x5xf32>)
      -> tensor<2x3x5xf32>
  return %0 : tensor<2x3x5xf32>

  // CHECK-LABEL: test_matmul_3d_batch_not_lowered
  // CHECK-NOT: linalg.matmul
  // CHECK: "onnx.MatMul"(%arg0, %arg1) : (tensor<2x3x4xf32>,
  // tensor<2x4x5xf32>) -> tensor<2x3x5xf32>
}

// -----

// Test that 1D x 2D is NOT lowered (should remain as onnx.MatMul)
func.func @test_matmul_1d_2d_not_lowered(%arg0: tensor<3xf32>,
    %arg1: tensor<3x4xf32>) -> tensor<4xf32> {
  %0 = "onnx.MatMul"(%arg0, %arg1) : (tensor<3xf32>, tensor<3x4xf32>)
      -> tensor<4xf32>
  return %0 : tensor<4xf32>

  // CHECK-LABEL: test_matmul_1d_2d_not_lowered
  // CHECK-NOT: linalg.matmul
  // CHECK: "onnx.MatMul"(%arg0, %arg1) : (tensor<3xf32>, tensor<3x4xf32>)
  // -> tensor<4xf32>
}
...
func.func @test_matmul_2d_1d_not_lowered(%arg0: tensor<2x3xf32>,
    %arg1: tensor<3xf32>) -> tensor<2xf32> {
  %0 = "onnx.MatMul"(%arg0, %arg1) : (tensor<2x3xf32>, tensor<3xf32>)
      -> tensor<2xf32>
